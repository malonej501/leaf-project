...
ITERATIONS = 10000  # length of chain default 1100000
ML_DATA = "ML_8_species_genus"  # ML_6_genus
BURNIN = 0  # to discard from posteriors - default 100000
DATASETS = [
...
def run_select_trees(data):
    ...
    for file in os.listdir("data"):
        if file.endswith((".Log.txt", ".pdf", ".Stones.txt")):
